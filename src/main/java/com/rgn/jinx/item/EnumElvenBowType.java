...
public enum EnumElvenBowType {
    /*
        Type(durability, baseDamage, velocityRatio, inaccuracy, chargeRatio, enchantability)
    */
    //VANILA ( 384, 2.0D, 3.00F, 1.00F, 1.00F,  1),
    LEATHER  ( 384, 2.0D, 5.00F, 2.00F, 0.50F, 10),
    COMPOSITE( 576, 3.0D, 4.00F, 0.50F, 1.00F,  1),
    ...
    ELVEN    ( 768, 1.0D, 3.00F, 0.25F, 1.50F, 15);
